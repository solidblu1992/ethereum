...
contract MLSAGVerify {
	...
	function ECMath_ChangeAddress(address ecMathAddr) public;
	function ECMath_Test() public constant returns (uint256[2]);
    ...
    function RingHashFunction(bytes32 msgHash, uint256[2] point) public view returns (uint256 h);
    function StartRing_NoHash(uint256 alpha) public constant returns (uint256[2] Pout);
    function StartRing(bytes32 msgHash, uint256 alpha) public constant returns (uint256 ckp);
    function CalculateRingSegment_NoHash(uint256 ck, uint256 sk, uint256[2] P) public constant returns (uint256[2] Pout);
    function CalculateRingSegment(bytes32 msgHash, uint256 ck, uint256 sk, uint256[2] P) public constant returns (uint256 ckp);
    ...
    function LinkableRingHashFunction(bytes32 msgHash, uint256[2] left, uint256[2] right) public view returns (uint256 h);
    ...
    function StartLinkableRing(bytes32 msgHash, uint256 alpha, uint256[2] P) public constant returns (uint256 ckp);
    ...
    function CalculateLinkableRingSegment(bytes32 msgHash, uint256 ck, uint256 sk, uint256[2] P, uint256[2] I) public constant returns (uint256 ckp);

    //Calculate keccak256 of given array
    function Keccak256OfArray(uint256[] array) public pure returns (uint256 out);
    function Keccak256OfArray(uint128[] array) public pure returns (uint256 out);
    ...
    function VerifySAG(bytes32 msgHash, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //P = {P1, P2, ... , Pn}
    //signature = {c1, s1, s2, ... , sn}
    function VerifySAG_Compressed(bytes32 msgHash, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //P = {P1x, P1y, P2x, P2y, ..., Pnx, Pny}
    //signature = {c1, s1, s2, ..., sn}
    function VerifyLSAG(bytes32 msgHash, uint256[] I, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //P = {P1, P2, ... , Pn}
    //signature = {c1, s1, s2, ... , sn}
    function VerifyLSAG_Compressed(bytes32 msgHash, uint256 I, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //                  s21, s22, ..., s2m,
    //                  sn1, sn2, ..., snm  }
    function VerifyMSAG(uint256 m, bytes32 msgHash, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //                  s21, s22, ..., s2m,
    //                  sn1, sn2, ..., snm  }
    function VerifyMSAG_Compressed(uint256 m, bytes32 msgHash, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    //                  s21, s22, ..., s2m,
    //                  sn1, sn2, ..., snm  }
    function VerifyMLSAG(bytes32 msgHash, uint256[] I, uint256[] P, uint256[] signature) public constant returns (bool success);
    ...
    function VerifyMLSAG_Compressed(bytes32 msgHash, uint256[] I, uint256[] P, uint256[] signature) public constant returns (bool success);
}
