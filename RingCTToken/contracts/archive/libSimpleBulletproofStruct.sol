...
library SimpleBulletproofStruct {
	//Structure for VerifySimpleBulletproof() arguments
	struct Data {
		uint256[2] V;
		uint256[2] A;
		uint256[2] S;
	...
	//Creates Simple Bullet Proof struct from uint256 array
	...
	//Decomposes Simple Bulletproof struct into uint256 array
